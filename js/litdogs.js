...
//определение параметров для запроса
    xmlhttp.open("GET", 'xml/schenki.xml', false);
    xmlhttp.send();
    ...
    for (i = 0; i < pet.length; i++) {
        ...
        //полученние элемента с id "litdogsgallery1" и вставка в него дочернего элемента addDiv
        document.querySelector('#litdogsgallery1').appendChild(addDiv);
    }
