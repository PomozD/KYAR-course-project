...
if (mediaQueryonIPad.matches) {
    document.getElementById('contactsHeadPhoto').style.marginTop = '15px';
    document.getElementById('divForHeadtext1').style.top = '43%';
        }
...
if (mediaQueryonPhone.matches) {
    document.getElementById('contactsHeadPhoto').style.marginTop = '10px';
    document.getElementById('divForHeadtext1').style.top = '31%';
}
    }
//срабатывание функции при клике по элементу и изменение стилей
...
if (mediaQueryoffIPad.matches) {
    document.getElementById('contactsHeadPhoto').style.marginTop = '0px';
    document.getElementById('divForHeadtext1').style.top = '19%';
}
// Создаем медиа условие, проверяющее страницу на ширину не более 376 пикселей
